...
(function ($) {
	...
	window.InlineShortcodeView_product_brand = window.InlineShortcodeView.extend( {
		render: function () {
			window.InlineShortcodeView_product_brand.__super__.render.call( this );
			var $id 	= this.$el.find( '.responsive-slider' );
			var $target = this.$el.find( '.responsive' );
			var $append = $id;
			vc.frame_window.vc_iframe.addActivity( function () {
	...
	window.InlineShortcodeView_respost_slide = window.InlineShortcodeView.extend( {
		render: function () {
			window.InlineShortcodeView_respost_slide.__super__.render.call( this );
			var $id 	= this.$el.find( '.responsive-slider' );
			var $target = this.$el.find( '.responsive' );
			var $append = $id;
			vc.frame_window.vc_iframe.addActivity( function () {
