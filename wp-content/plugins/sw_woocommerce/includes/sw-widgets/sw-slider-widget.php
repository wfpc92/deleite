			  ...
			  "params" => array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => 'default', 'Layout Top Rate' => 'toprated', 'Layout Best Sales' => 'bestsales', 'Layout Latest'=>'latest',  'Layout Latest 2'=>'latest2' ),
		...
		**/
		function WS_Shortcode( $atts, $content = null ){
			...
			elseif( $layout == 'latest' ){
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-slider/latest.php' );			
			}
			elseif( $layout == 'latest2' ){
				include( plugin_dir_path(dirname(__FILE__)).'/themes/sw-slider/latest2.php' );			
			}
