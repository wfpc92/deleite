<?php
class SW_PARADISE_Options_color extends SW_PARADISE_Options{	
	...
	*/
	function render(){
		...
		echo '<input type="text" id="'.esc_attr( $this->field['id'] ).'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" value="'.esc_attr( $this->value ).'" class="'.$class.' sw-paradise-popup-colorpicker" style="width:70px;"/>';
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			SW_PARADISE_URL.'/options/fields/color/field_color.js', 
