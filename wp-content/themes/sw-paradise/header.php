...
<body <?php body_class(); ?>>
	<div class="body-wrapper theme-clearfix">
		...
		$sw_paradise_my_address    = sw_paradise_options()->getCpanelValue('my_address');

		if ($sw_paradise_header_style == 'default'){ ?>
		<header id="header" class="header-<?php echo esc_attr( $sw_paradise_header_style ); ?>">
			<div class="top-header container">
			<?php if( $sw_paradise_my_phone != '' || $sw_paradise_my_delivery != '' || $sw_paradise_my_address != '' ) { ?>
				<div class="sw-paradise-header clearfix">
					<?php if($sw_paradise_my_phone != '') { ?>
					<div class="sw_paradise_phone col-md-4 col-sm-4 col-xs-12">
						<div class="main-phone">
							<span><?php esc_html_e('Contact us 24/7: ', 'sw-paradise') ?></span><?php echo esc_html($sw_paradise_my_phone ); ?>
						</div>
					</div>
					<?php } ?>
					...
					<?php } ?>
					<?php if($sw_paradise_my_address != '') { ?>
					<div class="sw_paradise_address col-md-4 col-sm-4 col-xs-12">
						<div class="main-address">
							<a href="<?php echo get_permalink( $sw_paradise_my_address ); ?>"><?php esc_html_e( 'Find our address', 'sw-paradise' ); ?></a>
						</div>
					</div>
					<?php } ?>
				</div>
			...
			<?php } else {
				echo '<div class="header-' . $sw_paradise_header_style . '">';
				get_template_part('templates/header', $sw_paradise_header_style);
				echo '</div>';
			} ?>
